...
sudo nmcli con add type wifi ifname wlan0 con-name SAAB autoconnect yes ssid SAAB
sudo nmcli con modify SAAB 802-11-wireless.mode ap 802-11-wireless.band a ipv4.method shared
sudo nmcli con modify SAAB wifi-sec.key-mgmt wpa-psk
sudo nmcli con modify SAAB wifi-sec.psk "1234567890"
sudo nmcli con up SAAB
