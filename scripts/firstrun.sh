...
if [ -f /usr/lib/raspberrypi-sys-mods/imager_custom ]; then
   /usr/lib/raspberrypi-sys-mods/imager_custom set_hostname SAAB
else
   echo SAAB >/etc/hostname
...
sudo nmcli con add type wifi ifname wlan0 con-name SAABnet autoconnect yes ssid SAABnet
sudo nmcli con modify SAABnet 802-11-wireless.mode ap 802-11-wireless.band a ipv4.method shared
sudo nmcli con modify SAABnet wifi-sec.key-mgmt wpa-psk
sudo nmcli con modify SAABnet wifi-sec.psk "585924202"
sudo nmcli con up SAABnet
